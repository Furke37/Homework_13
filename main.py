...
ronaldo = FootballPlayer(first_name="Cristiano", last_name="Ronaldo", height_cm=187, weight_kg=85, goals=807,
                         yellow_cards=90, red_cards=11)

messi = FootballPlayer(first_name="Lionel", last_name="Messi", height_cm=169, weight_kg=67, goals=681,
                       yellow_cards=84, red_cards=7)
